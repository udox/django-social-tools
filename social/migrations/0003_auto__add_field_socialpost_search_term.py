...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialPost.search_term'
        db.add_column(u'social_socialpost', 'search_term',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['social.SearchTerm']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialPost.search_term'
        db.delete_column(u'social_socialpost', 'search_term_id')
