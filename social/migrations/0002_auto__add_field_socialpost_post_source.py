...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialPost.post_source'
        db.add_column(u'social_socialpost', 'post_source',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialPost.post_source'
        db.delete_column(u'social_socialpost', 'post_source')
