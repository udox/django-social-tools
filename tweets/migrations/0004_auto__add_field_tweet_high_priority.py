...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.high_priority'
        db.add_column(u'tweets_tweet', 'high_priority',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.high_priority'
        db.delete_column(u'tweets_tweet', 'high_priority')
