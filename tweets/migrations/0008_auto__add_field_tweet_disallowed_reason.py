...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.disallowed_reason'
        db.add_column(u'tweets_tweet', 'disallowed_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.disallowed_reason'
        db.delete_column(u'tweets_tweet', 'disallowed_reason')
