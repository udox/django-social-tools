...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tweet.first_entry'
        db.delete_column(u'tweets_tweet', 'first_entry')

        # Adding field 'Tweet.entry_allowed'
        db.add_column(u'tweets_tweet', 'entry_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Tweet.first_entry'
        db.add_column(u'tweets_tweet', 'first_entry',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Tweet.entry_allowed'
        db.delete_column(u'tweets_tweet', 'entry_allowed')
    ...
    models = {
        ...
        u'tweets.tweet': {
            ...
            'auto_compose': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
